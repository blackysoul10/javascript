...
console.log('Inclye:', greeting.includes("Hola")) // Incluye
console.log(greeting.includes("Brais"))
console.log(greeting.includes("MoureDev"))
console.log('Sección: ', greeting.slice(0, 10)) // Sección
...
let nombre = 'Miguel'
let apellido = 'Carreño'

console.log(` Hola, ${nombre} ${apellido}`)
console.log('Incluye un valor?: ', nombre.slice(0,3));